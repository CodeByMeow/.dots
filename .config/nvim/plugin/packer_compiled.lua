...
_G.packer_plugins = {
  ...
  ["SchemaStore.nvim"] = {
    loaded = true,
    path = "/home/rose/.local/share/nvim/site/pack/packer/start/SchemaStore.nvim",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/rose/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["null-ls.nvim"] = {
    ...
    loaded = true,
    path = "/home/rose/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
  ...
  ["nvim-hlslens"] = {
    config = { "\27LJ\2\nm\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\23nearest_float_when\tauto\14calm_down\2\17nearest_only\2\nsetup\fhlslens\frequire\0" },
    keys = { { "", "/" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-treesitter"] = {
    after = { "vim-matchup", "nvim-ts-autotag", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-lspconfig'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'focus.nvim', 'FixCursorHold.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
