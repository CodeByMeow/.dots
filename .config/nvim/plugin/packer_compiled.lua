...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'focus.nvim', 'nvim-colorizer.lua', 'FixCursorHold.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
