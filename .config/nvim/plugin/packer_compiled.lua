...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'focus.nvim', 'nvim-colorizer.lua', 'alternate-toggler', 'indent-blankline.nvim', 'winshift.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
