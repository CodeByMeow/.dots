...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'FixCursorHold.nvim', 'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'focus.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
