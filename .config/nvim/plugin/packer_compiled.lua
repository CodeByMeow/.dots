...
_G.packer_plugins = {
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/home/rose/.local/share/nvim/site/pack/packer/start/nvim-surround",
    url = "https://github.com/kylechui/nvim-surround"
  },
  ["nvim-treesitter"] = {
    after = { "vim-matchup", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-ts-autotag" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'focus.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter', 'FixCursorHold.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
