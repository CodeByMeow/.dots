...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'indent-blankline.nvim', 'winshift.nvim', 'focus.nvim', 'alternate-toggler'}, { event = "BufRead *" }, _G.packer_plugins)]]
