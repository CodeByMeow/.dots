...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'focus.nvim', 'winshift.nvim', 'indent-blankline.nvim', 'alternate-toggler'}, { event = "BufRead *" }, _G.packer_plugins)]]
